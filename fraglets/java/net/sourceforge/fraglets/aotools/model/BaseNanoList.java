 ...
 * Created on 3. August 2001, 17:56
 */
...
public class BaseNanoList {
    ...
    public void print(){
        ...
        try{
            ...
            out.println(formatString("Nano Cluster", 15)+
            formatString("Skill", 15)+formatString("Faded", 10)+
            formatString("Bright", 10)+formatString("Shining", 10));
            out.println("-----------------------------------------------------------");
            Iterator i = getAllNanos();
            while(i.hasNext()){
                if(next == null)
                    b = (BaseNanoCluster)i.next();
                else
                    b = next;
