 ...
 * Created on December 1, 2002, 8:59 AM
 */
...
public class TGAViewer extends javax.swing.JFrame {
    ...
    private void aboutMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aboutMenuItemActionPerformed
        ...
        JOptionPane.showMessageDialog(this,
            MessageFormat.format(aboutText, new Object[] {"TGAViewer", "0.1"}),
            "About TGAViewer", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_aboutMenuItemActionPerformed

    protected JFileChooser chooser = new JFileChooser();
    {
        FileFilter filter = new FileFilter() {
            public String getDescription() { return "TARGA images (*.tga)"; }
            public boolean accept(File file) { return file.isDirectory() || file.getName().toLowerCase().endsWith(".tga"); }
        };
